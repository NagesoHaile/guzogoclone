...
List<AirportModel> airportList = <AirportModel>[
  ...
  AirportModel(city: 'Hawasa', cityCode: 'AWA', airportName: 'Hawasa Airport'),
  ...
  AirportModel(city: 'Jijiga', cityCode: 'JIJ', airportName: 'Jijiga Airport'),
  AirportModel(
  ...
  AirportModel(city: 'Semera', cityCode: 'SZE', airportName: 'Semera Airport'),
  AirportModel(
      city: 'Nekemte', cityCode: 'NEK', airportName: 'Nekemte Airport'),
  AirportModel(city: 'Jimma', cityCode: 'JIM', airportName: 'Jimma Airport'),
  AirportModel(city: 'Gondar', cityCode: 'GDQ', airportName: 'Gondar Airport'),
];
